...
public class Source extends BaseTimeEntity {
    ...
    @Enumerated(EnumType.STRING) @Column(name = "trust_type", nullable = false, length = 20)
    private TrustType trustType;

    @Enumerated(EnumType.STRING) @Column(name = "verification_policy", nullable = false, length = 30)
