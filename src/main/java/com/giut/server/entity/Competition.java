...
public class Competition extends BaseTimeEntity {
    ...
    @Column(name = "host_organization", length = 150) private String hostOrganization;
    @Column(name = "target_participants", columnDefinition = "text") private String targetParticipants;
    @Column(columnDefinition = "text") private String summary;
    @Column(name = "application_start_at") private Instant applicationStartAt;
    @Column(name = "application_end_at") private Instant applicationEndAt;
    @Enumerated(EnumType.STRING) @Column(name = "publication_status", nullable = false, length = 20) private PublicationStatus publicationStatus;
