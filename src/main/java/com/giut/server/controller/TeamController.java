    ...
    @ApiResponses({
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(value = "{\"applicationId\":1,\"teamId\":1,\"userId\":15,\"message\":\"백엔드 개발로 참여하고 싶습니다.\",\"status\":\"PENDING\",\"appliedAt\":\"2026-09-08T10:40:00Z\",\"decidedAt\":null}")
                    )
            ),
            @ApiResponse(
                    responseCode = "400",
    ...
    @ApiResponses({
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = TeamApplicationResponse.class),
                            examples = @ExampleObject(value = "{\"applicationId\":1,\"teamId\":1,\"userId\":15,\"message\":\"백엔드 개발로 참여하고 싶습니다.\",\"status\":\"REJECTED\",\"appliedAt\":\"2026-09-08T10:40:00Z\",\"decidedAt\":\"2026-09-08T10:45:00Z\"}")
                    )
            ),
            @ApiResponse(
                    responseCode = "400",
